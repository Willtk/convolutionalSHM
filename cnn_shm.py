...
imgs_padronizadas= imgs_padronizadas.reshape(np_lista_imgs.shape[0],linhas_img,colunas_img,num_channel)    #Reformatando a imagem para ficar no padrão da entrada.
...
x,y = shuffle(imgs_padronizadas,Y, random_state=2)                                           #Embaralhando a lista de imagens
